    ...
    <ion-page>
        <ion-content>
            <div class="mx-4 relative">
                ...
                <div class="relative mb-8 bg-[#E84344]/80 inline-block z-20 py-1 px-4 rounded-bl-[20px] rounded-tr-[20px] shadow-card-shadow" id="lets-talk">
                ...
                <div class="grid grid-cols-1 z-20 tablet:grid-cols-2 lg-tablet:grid-cols-3 gap-4 mb-8">
                ...
                <div class="grid grid-cols-2 lg-tablet:grid-cols-3 gap-4 mb-8 z-20">
                ...
                <div class="absolute top-4 left-10 z-10">
