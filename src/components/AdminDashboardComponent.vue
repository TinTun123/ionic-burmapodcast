<template>
    <div class="mx-4 mt-8 tablet:mx-8">
        ...
        <div class="relative mb-8">
          ...
          <span class="absolute text-white/80 font-semibold text-lg top-[50%] -translate-y-[50%]">Show</span>
        ...
        laptop:justify-center">
            ...
            <div @click="routeTo(shows.id)" v-for="(shows, index) in showStore.shows" :key="index" 
